describe('container', function () {
  ...
  function isPresent(elementSelector) {
    return createMatcher({
      ...
      success: 'Expected element ' + elementSelector + ' to be present',
      fail: this.success + ', but it wasn\'t'
    });
  }
  ...
  function checkDropRowVisibility(position) {
    return createMatcher({
      ...
      success: 'Expected drop row to be visible' + position === 'prev' ? 'before' : 'after',
      fail: this.success + ', but it wasn\'t'
    });
  }
});
