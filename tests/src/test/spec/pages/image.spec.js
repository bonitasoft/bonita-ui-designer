describe('image', function() {
  ...
  beforeEach(function() {
    browser.get('/bonita/preview/page/no-app-selected/image/');
  });

  it('should display a an image', function() {
    var images = $$('pb-image img');

    expect(images.get(0).getAttribute('src')).toBe("http://localhost:8086/bonita/preview/page/no-app-selected/image/assets/img/bonitaLogo.png");
