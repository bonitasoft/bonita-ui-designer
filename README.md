...
* Run it using `java -jar backend/webapp/target/ui-designer-1.16.12-standalone.jar`
...
backend/webapp/target/ui-designer-1.16.12.war
backend/webapp/target/ui-designer-1.16.12-standalone.jar
...
To run build standalone jar, just launch it as a standard jar :
    ...
    java -jar backend/webapp/target/ui-designer-1.16.12-standalone.jar [-Dworkspace=/path/to/workspace] [-Drepository.widgets=/path/widgets/repository] [-Drepository.pages=/path/pages/repository][-Dbonita.data.repository.origin=datarepository.url]
...
Available options can be listed by running 
    ...
    java -jar backend/webapp/target/ui-designer-1.16.12-standalone.jar -h
