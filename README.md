...
backend/target/ui-designer-1.8.40_a0b2p00000ROW9A.war
backend/target/ui-designer-1.8.40_a0b2p00000ROW9A-standalone.jar
...
To run build standalone jar, just launch it as a standard jar :
    ...
    java -jar backend/target/ui-designer-1.8.40_a0b2p00000ROW9A-standalone.jar [-Dworkspace=/path/to/workspace] [-Drepository.widgets=/path/widgets/repository] [-Drepository.pages=/path/pages/repository]
...
Available options can be listed by running 
    ...
    java -jar backend/target/ui-designer-1.8.40_a0b2p00000ROW9A-standalone.jar -h
