...
EXPOSE 8080
WORKDIR /data
ADD ./backend/webapp/target/ui-designer-1.13.6-standalone.jar /data/ui-designer-standalone.jar
CMD java -jar ui-designer-standalone.jar -Ddesigner.experimental=true
