...
public class ModalContainerBuilder extends ElementBuilder<ModalContainer> {
    ...
    private ModalContainerBuilder() {
        ...
        modalContainer.setId(id);
        modalContainer.setReference(reference);
    }
    ...
    public ModalContainerBuilder with(Container container) {
        modalContainer.setContainer(container);
        return this;
    }

    public ModalContainerBuilder with(ContainerBuilder container) {
