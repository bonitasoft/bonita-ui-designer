...
public class IncludeChildDirectoryPredicate implements Zipper.PathPredicate {
    ...
    private final Set<String> acceptedChildDirectoryNames;

    public IncludeChildDirectoryPredicate(Path sourceDirectory, Set<String> acceptedChildDirectoryNames) {
        this.sourceDirectory = sourceDirectory;
        this.acceptedChildDirectoryNames = acceptedChildDirectoryNames;
    }
