...
public class FragmentDirectiveBuilderTest {
    ...
    public void setUp() throws Exception {
        ...
        fragmentDirectiveBuilder = new FragmentDirectiveBuilder(watcher, objectMapper, htmlBuilderVisitor, htmlSanitizer);
        ...
        write(fragmentFile.toPath(), objectMapper.toJson(fragment));
