...
import static org.bonitasoft.web.designer.experimental.parametrizedWidget.ParameterType.INTERPOLATION;
...
public class TitleWidgetTest {
    ...
    public void should_create_a_component_with_an_interpolated_text_property_value() {
        ...
        assertThat(title.toComponent(new DimensionFactory()).getPropertyValues().get("text").getType()).isEqualTo(INTERPOLATION.getValue());
    }
}
