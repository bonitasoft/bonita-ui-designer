...
public class ContractToContainerMapperTest {
    ...
    @Test
    public void should_set_value_relative_to_business_data() throws Exception {
        ContractToContainerMapper contractToContainerMapper = makeContractToContainerMapper();

        Container container = contractToContainerMapper.create(aSimpleContractWithDataRef());
